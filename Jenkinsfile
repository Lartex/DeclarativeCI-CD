...
/*   post {
   always {
    ...
    failure {
      ...
      emailext body: "<br>Project: ${env.JOB_NAME} <br>Build Number: ${env.BUILD_NUMBER} <br>URL: ${env.BUILD_URL}", mimeType: 'text/html', subject: "ERROR: Project name -> ${env.JOB_NAME}"
      recipientProviders: [
        [$class: 'DevelopersRecipientProvider'],
        [$class: 'RequesterRecipientProvider']
      ], subject: 'Test', to: 'lartex7@gmail.com'
